...
class _LaneNetCluster(object):
	...
	def _get_lane_embedding_feats(binary_seg_ret, instance_seg_ret):
		...
		:return:
		"""
		idx = np.where(binary_seg_ret >= 250)
		# print (idx)
	...
	def apply_lane_feats_cluster(self, binary_seg_result, instance_seg_result):
		...
		print ("labels,unique,coord")
		print (db_labels.shape)
		print (unique_labels.shape)
		print (coord.shape)
		print (dbscan_cluster_result['cluster_nums'])
		...
		return mask, lane_coords ,get_lane_embedding_feats_result['lane_embedding_feats']
...
class LaneNetPostProcessor(object):
	...
	def postprocess(self, binary_seg_result, instance_seg_result=None,
		...
		cv2.imshow("sam",morphological_ret)
		cv2.waitKey(0)
		...
		mask_image, lane_coords,features_list = self._cluster.apply_lane_feats_cluster( 	morphological_ret,
