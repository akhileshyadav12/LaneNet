...
__C.TRAIN.DATA_DIR = "tusimple_dataset/train_data.txt"
__C.TRAIN.IMG_DIR = "tusimple_dataset/"
__C.TRAIN.DATA_DIR = "lanenet/data/data.txt"
__C.TRAIN.IMG_DIR = "lanenet/data/"
...
__C.TRAIN.CPU_MULTI_PROCESS_NUMS = 4
